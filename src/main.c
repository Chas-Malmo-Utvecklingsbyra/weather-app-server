...
#include "core/tcp/server/tcp_server.h" /* TODO: SS - Fix with makefile. We should be able to write '#include "tcp/server/tcp_server.h"'.*/
...
int main() {
    ...
    if(start_server_result != TCP_Server_Result) {
